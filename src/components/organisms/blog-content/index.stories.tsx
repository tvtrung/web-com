...
export default {
  title: 'Components/Organisms/BlogContent',
  component: BlogContent,
} as ComponentMeta<typeof BlogContent>;

const Template: ComponentStory<typeof BlogContent> = args => <BlogContent {...args} />;
...
Normal.args = {
  children: (
    <>
      ...
      <div className="u-column-2" data-gap="49">
        <h4>
